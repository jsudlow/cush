...
/* Command for C compiler:
   gcc -c  -w  -I/home/jsudlow/Nim/lib -o .nimcache/consts.o .nimcache/consts.c */
...
NIM_EXTERNC N_NOINLINE(void, HEX00_constsInit)(void) {
	nimfr("consts", "consts.nim")
	popFrame();
}

NIM_EXTERNC N_NOINLINE(void, HEX00_constsDatInit)(void) {
}
