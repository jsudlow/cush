...
/* Command for C compiler:
   gcc -c  -w  -I/home/jsudlow/Nim/lib -o .nimcache/game.o .nimcache/game.c */
...
N_NIMCALL(void, enter_165004)(gamescene126010* self) {
	nimfr("enter", "game.nim")
	nimln(6, "game.nim");
	asgnRef((void**) (&(*self).Hoversystem), newhoversystem_133017(self));
	nimln(7, "game.nim");
	asgnRef((void**) (&(*self).Clicksystem), newclicksystem_164007(self));
	popFrame();
}
...
N_NIMCALL(void, update_165014)(gamescene126010* self, NI t, NI dt) {
	...
	nimln(11, "game.nim");
	update_133058((*self).Hoversystem, t, dt);
	nimln(12, "game.nim");
	haswon = hasplayerwon_130449((*self).Sup.Ctl);
	nimln(13, "game.nim");
	(*self).Haswon = haswon;
	popFrame();
}
...
N_NIMCALL(void, mousedown_165027)(gamescene126010* self, tmousebuttonevent115383* event) {
	nimfr("mouse_down", "game.nim")
	nimln(16, "game.nim");
	mousedown_164061((*self).Clicksystem, event);
	popFrame();
}
