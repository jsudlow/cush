...
/* Command for C compiler:
   gcc -c  -w  -I/home/jsudlow/Nim/lib -o .nimcache/cushentry.o .nimcache/cushentry.c */
...
NIM_EXTERNC N_NOINLINE(void, cushentryInit)(void);
NIM_EXTERNC N_NOINLINE(void, cushentryDatInit)(void);
STRING_LITERAL(TMP765, "Generic Cush Game", 17);
...
N_NIMCALL(void, leave_128025)(scene126006* self) {
	...
	nimln(7, "scene.nim");
	{
		...
		nimln(7, "scene.nim");
		if (self) chckObj((*self).Sup.m_type, (&NTI126012));
		leave_132030(((menuscene126012*) (self)));
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(void, keydown_128040)(scene126006* self, NI32 key, NI32 mods) {
	...
	nimln(10, "scene.nim");
	{
		...
		nimln(10, "scene.nim");
		if (self) chckObj((*self).Sup.m_type, (&NTI126012));
		keydown_132040(((menuscene126012*) (self)), key, mods);
	}
	goto LA1;
	LA3: ;
	{
...
N_NIMCALL(void, draw_128081)(scene126006* self) {
	...
	LA3: ;
	{
		...
		nimln(19, "scene.nim");
		if (self) chckObj((*self).Sup.m_type, (&NTI126012));
		draw_132082(((menuscene126012*) (self)));
	}
	goto LA1;
	LA6: ;
	{
...
N_NIMCALL(void, mousedown_164061)(clicksystem126016* self, tmousebuttonevent115383* event) {
	nimfr("mouse_down", "clicksystem.nim")
	nimln(9, "clicksystem.nim");
	mousedown_164048(self, event);
	popFrame();
}
...
NIM_EXTERNC N_NOINLINE(void, cushentryInit)(void) {
	scene126006* LOC1;
	nimfr("cushentry", "cushentry.nim")
	nimln(3, "cushentry.nim");
	asgnRef((void**) (&menuscene_166032), new_166006());
	nimln(4, "cushentry.nim");
	asgnRef((void**) (&gameapp_166065), new_166039());
	nimln(5, "cushentry.nim");
	LOC1 = 0;
	LOC1 = &menuscene_166032->Sup;
	init_131007(gameapp_166065, LOC1, ((NI32) 500), ((NI32) 500), ((NimStringDesc*) &TMP765));
	nimln(6, "cushentry.nim");
